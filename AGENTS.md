...
## Overview
24/7 autonomous AI pipeline that runs a portfolio of faceless, single-subject short-form video channels. Orchestrated by Codex, deployed via GitHub Actions. MVP: one Korean-language YouTube Shorts channel, asset-assembly only, approval-gated.
...
| Layer | Tech |
|-------|------|
| Pipelines | Python 3.12, Codex Agent SDK, ffmpeg, moviepy |
...
| Models | Codex Opus 4.6 (creative), Codex Haiku 4.5 (mechanical) |
