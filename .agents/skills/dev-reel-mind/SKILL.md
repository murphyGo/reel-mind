---
name: dev-reel-mind
description: Execute Reel-Mind AIDLC construction work by reading aidlc-docs/aidlc-state.md, selecting the next stage or unit, implementing one step, and validating it. Use when asked to run /dev-reel-mind or start development.
metadata:
  short-description: Run Reel-Mind construction
---
...
protocol from `.Codex/skills/code-review/protocols/`:
