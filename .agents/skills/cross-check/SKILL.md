---
name: cross-check
description: Verify Reel-Mind implementation against documented requirements, FR/NFR IDs, components, and AIDLC acceptance criteria. Use when asked to run /cross-check or validate completed work.
metadata:
  short-description: Verify requirements compliance
---
