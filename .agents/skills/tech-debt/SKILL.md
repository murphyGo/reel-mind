---
name: tech-debt
description: Inspect and manage Reel-Mind technical debt items, including filtering, escalation, promotion, and resolution flows. Use when asked to run /tech-debt or choose debt to address.
metadata:
  short-description: Manage technical debt
---
