---
name: scaffold
description: Generate Reel-Mind project directories and configuration scaffolding from AI-DLC specs without application code. Use when asked to run /scaffold or prepare the repo skeleton.
metadata:
  short-description: Scaffold project structure
---
