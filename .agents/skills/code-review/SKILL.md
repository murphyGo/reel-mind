---
name: code-review
description: Review Reel-Mind code changes for quality, security, test coverage, and project-specific Python and TypeScript standards. Use when asked to run /code-review or review git changes before committing.
metadata:
  short-description: Review Reel-Mind changes
---
...
**Frameworks**: Codex Agent SDK + ffmpeg/moviepy (Python); Next.js 15 App Router (TypeScript)
**Lint Commands**:
- Python: `ruff check .`
